import { BRAND_NAME, LOCKUPS, SPINE, BOILERPLATE, MANIFESTO, CONTACT_EMAIL, INVITATION, PARENT_LINE, timeline, CREATIVE_FRAMEWORK } from "@/config/brand";
import "./print.css";
